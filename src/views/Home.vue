  ...
  <div class="app">
    <div class="space-x-4 ...">
      <div class="inline-block ...">
          ...
          <a class="text-gray-800 text-xl font-bold md:text-1xl"
...
<!-- <p class="clear-none ...">Deux tableau indiquant respectivement le nombre de personne ayant guéri du Covid19 ainsi que le le nombre de mort par pays </p> -->
...
export default {
  ...
  methods: {
    ...
    async initFrance() {
      ...
      this.seriesRecovery[0].data.push(data.response[0].cases.recovered);
      this.seriesDeaths[0].data.push(data.response[0].deaths.total);
      this.options.xaxis.categories.push(data.response[0].country);
    },
    async initSpain() {
